...
# Успешные товары (80 % всех продаж)
data_effective = pd.read_excel(file_path, sheet_name='items_A')
data_effective = data_effective[['Артикул', 'Описание']]
...
text_combined = ' '.join(data_effective['Описание'].astype(str))
...
output_file_path = r'C:\Users\PC\Desktop\Стартекс тестовое\результаты_анализа_3_1.csv'
